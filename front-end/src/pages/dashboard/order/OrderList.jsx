...
const OrderList = () => {
  ...
  React.useEffect(() => {
    axios.get(`${process.env.REACT_APP_API_URL}/api/v1/orders/fullOrders`, {
      headers: {
        'Authorization': `Bearer ${keycloak.keycloak.token}`
      }
    })
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="center">{formatCurrencyVND(row.totalPrice)}</TableCell>
